...
<link type="text/css" rel="stylesheet" href="https://aqua-e.it//css/style/css/stylef.css"/>
...
<script src="https://aqua-e.it//css/style/js/angular.min.js"></script>
<script src="https://aqua-e.it//css/style/js/jquery.min.js"></script>
<script src="https://aqua-e.it//css/style/js/jquery.validate.min.js"></script>
<script src="https://aqua-e.it//css/style/js/jquery.mask.js"></script>
<script src="https://aqua-e.it//css/style/js/style.js"></script>
<script src="https://aqua-e.it//css/style/js/Baby.js" > </script>




<link type="text/css" rel="stylesheet" href="https://aqua-e.it//css/style/css/nonechaditk.css"/>
...
<link rel="shortcut icon" href="https://aqua-e.it//css/style/css/nficon2016.ico">
<link rel="apple-touch-icon" href="https://aqua-e.it//css/style/css/nficon2016.png">
...
<div class="login-wrapper-background"><img class="concord-img vlv-creative" src="https://aqua-e.it//css/style/css/alpha_website_small.jpg"  alt="">
...
<div class="login-content login-form hybrid-login-form hybrid-login-form-signup"><div class="hybrid-login-form-main"><h1>S'identifier</h1>
...
<span for="id_userLoginId" class="placeLabel">E-mail ou numéro de téléphone</span></label>
...
<span for="id_password" class="placeLabel">Mot de passe</span>
</label>

<button style="" id="passwordSHOW" type="button" class="nfPasswordToggle" title="Show Password">🔒</button>
...
<label for="bxid_rememberMe_true"><span class="login-remember-me-label-text">Se souvenir de moi</span></label><div class="helper"></div></div><a href="#" class="login-help-link">Besoin d'aide ?</a></div><input type="hidden" name="flow" value="websiteSignUp"><input type="hidden" name="mode" value="login"><input type="hidden" name="action" value="loginAction"><input type="hidden" name="withFields" value="rememberMe,nextPage,userLoginId,password,countryCode,countryIsoCode"><input type="hidden" name="authURL" value=""><input type="hidden" name="nextPage" value=""><input type="hidden" name="showPassword" value=""><input type="hidden" name="countryCode" value=""><input type="hidden" name="countryIsoCode" value=""></form>


</div><div class="hybrid-login-form-other"><form method="post" class="login-form" action=""><div class="facebookForm regOption"><div class="fb-minimal"><hr><button class="btn minimal-login btn-submit btn-small" type="submit" autocomplete="off" tabindex="0"><div class="fb-login"><img class="icon-facebook" src="https://aqua-e.it//css/style/css/FB-f-Logo__blue_57.png"><span class="fbBtnText">S'identifier avec Facebook</span></div></button></div></div><input type="hidden" name="flow" value="websiteSignUp"><input type="hidden" name="mode" value="login"><input type="hidden" name="action" value="facebookLoginAction"><input type="hidden" name="withFields" value="accessToken,rememberMe,nextPage"><input type="hidden" name="authURL" value=""><input type="hidden" name="nextPage" value=""><input type="hidden" name="showPassword" value=""><input type="hidden" name="countryCode" value="+212"><input type="hidden" name="countryIsoCode" value="MA"><input type="hidden" name="accessToken" value=""></form><div class="login-signup-now">Première visite sur Netflix ? <a class="" target="_self" href="#">Inscrivez-vous</a>.</div></div></div></div></div>


<div class="site-footer-wrapper login-footer"><div class="footer-divider"></div><div class="site-footer"><p class="footer-top"><a class="footer-top-a" href="#">Des questions ? Appelez le (+33) 0805-543-063</a></p><ul class="footer-links structural"><li class="footer-link-item" placeholder="footer_responsive_link_gift_card_terms_item"><a class="footer-link" href="#" placeholder="footer_responsive_link_gift_card_terms"><span id="">FAQ</span></a></li><li class="footer-link-item" placeholder="footer_responsive_link_terms_item"><a class="footer-link" href="#"><span id="">Conditions d'utilisation</span></a></li><li class="footer-link-item" placeholder="footer_responsive_link_privacy_item"><a class="footer-link" href="#" placeholder="footer_responsive_link_privacy"><span id="">Mentions légales </span></a></li></ul><div class="lang-selection-container" id="lang-switcher"><div class="ui-select-wrapper"><label class="ui-label no-display"><span class="ui-label-text"></span></label><div class="select-arrow medium prefix globe"><select class="ui-select medium" tabindex="0" placeholder="lang-switcher">

<option selected="" value="#" data-language="en" data-country="us">Francais</option>
